...
export const PETITION_CHAIN_OF_COMMAND = [
  ...
  "Registrar — final review, approval, or rejection (only the Registrar can close your petition)",
];
  ...
  switch (newStatus) {
    case "under_review":
      return {
        ...
        nextStep:
          "Next: the Class Advisor may forward your petition to the Registrar for a final decision.",
      };
    case "forwarded_to_hod":
    case "forwarded_to_registrar":
      return {
        headline: "Forwarded to Registrar",
        summary: `${by} completed their review and forwarded your petition to the Registrar.`,
        nextStep:
