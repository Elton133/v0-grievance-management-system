...
export const PETITION_CHAIN_OF_COMMAND = [
  ...
  "Head of Department (HOD) — department review and forward",
  ...
  switch (newStatus) {
    ...
    case "forwarded_to_hod":
      return {
        ...
        nextStep:
          "Next: the HOD will review and forward to the Registrar. Only the Registrar can approve or reject your petition.",
      };
